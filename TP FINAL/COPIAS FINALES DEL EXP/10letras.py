...
def mostrar_enfoque_deslizante(serie_letras):
    ...
    espacio = total_espacio / (10 - 1)  # Espacio distribuido entre 5 letras
...
PARTICIPANT_FILENAME = 'C:/Users/Admin/Desktop/EXPERIMENTO/Respuestas10letras/' + 'data10_' + str(ARCHIVO) + '.csv' # !!!!
