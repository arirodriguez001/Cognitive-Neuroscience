...
from time import gmtime, strftime
                                                                        #INSTRUCCIONES: hacer lo que dice la linea 185
                                                                        #y despues ponerle "play" con el botón de arriba.
                                                                        #Si lo ponen por accidente o una vez empezado el
                                                                        #experimento quieren salir, en cualquier momento
                                                                        #pueden apretar "Q". Respondan tranquilos, tomandose
                                                                        #su tiempo. No hay respuesta correcta.
...
PARTICIPANT_FILENAME = '/Users/Usuario/Desktop/Anabella/neurociencia/'+ 'data_' + str(ARCHIVO) + '.csv'
#INSTRUCCIONES: cambiar "/Users/Usuario/Desktop/Anabella/neurociencia" por la direccion de la carpeta
#de su compu en donde quieran que se guarde el archivo que despues me tienen que mandar. Asegurense de
#que lo ponen entre comillas " o ' y cambien las barras \ por /.
