...
from time import gmtime, strftime
                                                            #NOTA: ya guarda con gui y mide el tpo de rta. 
                                                            #Esta con las 30 pantallas, deje los valores 
                                                            #escritos que tenia la version acortada 
...
def generar_preguntas_combinadas():
    posiciones = list(range(7))  # Posiciones de 0 a 6 (correspondientes a las posiciones 1 a 7)     CAMBIADO. era 2
...
dlg.addField('archivo', 'Nombre/nro', initial='1')

SESSION = dlg.show() #dlg.show es un diccionario que guarda los inputs 
print(SESSION)       #tira: {'archivo': 'input'}
...
PARTICIPANT_FILENAME = '/Users/Usuario/Desktop/Anabella/neurociencia/'+ 'data_' + str(ARCHIVO) + '.csv' #dire donde se guarda la data
...
mostrar_instrucciones(
    "Lea atentamente."
    "\n\n En este experimento se le mostrarán siete letras en la pantalla y luego"
...
#guardado de la data
numtrials= 30 #cantidad total de pantallas/trials                        #CAMBIADO, era 6
data = {'Trial':np.arange(1,numtrials+1), 'letras':data_7letras, 'pregunta':data_letra_pregunta, 'respuesta':data_respuesta, 'tiempo': data_tiempo_rta} #faltaria el tiempo de respuesta
