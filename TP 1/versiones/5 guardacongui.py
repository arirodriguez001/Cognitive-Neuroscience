...
from time import gmtime, strftime
                                                            ...
                                                            #faltaria ver si medir los tiempos de respuesta (yo diria de hacerlo)
...
PARTICIPANT_FILENAME = '/Users/Usuario/Desktop/Anabella/neurociencia/'+ 'data_' + str(ARCHIVO) + '.csv' #donde se guarda la data
